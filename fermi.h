...
#define FERMI_VERSION "0.0-dev (r142)"
...
extern "C" {
	...
	struct __rld_t *fm_append(struct __rld_t *e0, int len, uint8_t *T);
	 ...
	 */
	struct __rld_t *fm_merge(struct __rld_t *e0, struct __rld_t *e1, int use_hash);
